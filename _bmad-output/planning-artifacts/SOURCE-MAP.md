...
| `architecture/architecture-bronze-app-2026-08-27/ARCHITECTURE-SPINE.md` | `docs/06`, `docs/18`, `docs/07`, `docs/08`, `docs/09`, `docs/21` | CAP/QUE/WIN/DAT/SEC | ADR-001–017 accepted; 002/009/018 deferred; ADR-019 Proposed |
