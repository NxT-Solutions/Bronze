...
| T-05 | XSS in item/Markdown | render text via text nodes; sanitize Markdown; no raw HTML/remote resource; strict CSP | malicious corpus, CSP test |
...
| T-10 | Remote exfiltration | zero network capabilities/dependencies at runtime; deny navigation; packet capture gate | offline network test |
