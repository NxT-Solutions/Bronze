...
pub use schema::{
    ...
    PanelEdge, SchemaError, SettingsField, SettingsGroup, SettingsV1, ShortcutActionId,
    ShortcutBinding, TestedState, TitleModelId, TriggerKind, DEFAULT_GAP_MS, DEFAULT_MAX_HOLD_MS,
